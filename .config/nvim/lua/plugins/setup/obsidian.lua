    ...
    require("obsidian").setup {
      ...
      ui = {
        ...
        hl_groups = {
          ...
          ObsidianTodo = { bold = true, fg = "#316D89" },
          ObsidianDone = { bold = true, fg = "#B598D4" },
          ObsidianRightArrow = { bold = true, fg = "#316D89" },
          ObsidianTilde = { bold = true, fg = "#ECB973" },
          ObsidianBullet = { bold = true, fg = "#B598D4" },
          ObsidianRefText = { underline = true, fg = "#E66C8F" },
          ObsidianExtLinkIcon = { fg = "#E66C8F" },
          ObsidianTag = { italic = true, fg = "#B598D4" },
          ObsidianBlockID = { italic = true, fg = "#B598D4" },
          ObsidianHighlightText = { bg = "#D588F7" },
        },
      },
